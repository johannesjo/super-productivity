...
import { buildIssueWorklogs, CalDavClient, fromJiraDescription, importBacklogSeeds, issueToTaskSeed, IssuePoller, JiraClient, parseIcs, worklogToJiraPayload, } from './index';
    ...
    it('queries a CalDAV calendar and returns parsed events', async () => {
        ...
        const fetchImpl = async (input, init) => {
            if (init?.method === 'REPORT') {
                return new Response(`<D:multistatus xmlns:D="DAV:" xmlns:C="urn:ietf:params:xml:ns:caldav"><D:response><C:calendar-data>${ics.replace(/</g, '&lt;')}</C:calendar-data></D:response></D:multistatus>`, { status: 207 });
            }
            return new Response('<D:multistatus xmlns:D="DAV:"><D:response><D:href>/cal/personal/</D:href></D:response></D:multistatus>', { status: 207 });
        };
        ...
        const events = await client.events('/cal/personal/', '2026-07-20T00:00:00Z', '2026-07-22T00:00:00Z');
