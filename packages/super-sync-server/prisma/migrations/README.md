...
Before running the out-of-band `DROP`, recovery also terminates any **orphaned**
`CONCURRENTLY` build left running by an interrupted prior deploy. PostgreSQL does
