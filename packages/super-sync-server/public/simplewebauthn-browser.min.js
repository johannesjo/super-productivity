!(function (e, t) {
  ...
  function h() {
    if (!n()) return p.stubThis(new Promise((e) => e(!1)));
  ...
  (e.WebAuthnAbortService = l),
    ...
    (e.browserSupportsWebAuthnAutofill = h),
    ...
    (e.startAuthentication = async function (e) {
      !e.optionsJSON &&
        e.challenge &&
        (console.warn(
      ...
      const {
        optionsJSON: o,
        useBrowserAutofill: c = !1,
        verifyBrowserAutofillInput: d = !0,
      } = e;
      if (!n()) throw new Error('WebAuthn is not supported in this browser');
      let p;
      0 !== o.allowCredentials?.length && (p = o.allowCredentials?.map(i));
      const f = { ...o, challenge: r(o.challenge), allowCredentials: p },
        b = {};
      if (c) {
      ...
      let R;
      (b.publicKey = f), (b.signal = l.createNewAbortSignal());
      try {
      ...
      let m;
      return (
        A.userHandle && (m = t(A.userHandle)),
        {
          id: g,
          rawId: t(w),
          response: {
            authenticatorData: t(A.authenticatorData),
            clientDataJSON: t(A.clientDataJSON),
            signature: t(A.signature),
            userHandle: m,
          },
          type: E,
          clientExtensionResults: R.getClientExtensionResults(),
          authenticatorAttachment: u(R.authenticatorAttachment),
        }
      );
    }),
    (e.startRegistration = async function (e) {
      ...
      const h = {
          ...o,
          challenge: r(o.challenge),
          user: { ...o.user, id: r(o.user.id) },
          excludeCredentials: o.excludeCredentials?.map(i),
        },
        p = {};
      let f;
      c && (p.mediation = 'conditional'),
        (p.publicKey = h),
        (p.signal = l.createNewAbortSignal());
      try {
      ...
      if (!f) throw new Error('Registration was not completed');
      const { id: b, rawId: R, response: g, type: w } = f;
      let A, E, m, y;
      if (
        ('function' == typeof g.getTransports && (A = g.getTransports()),
        'function' == typeof g.getPublicKeyAlgorithm)
      )
        try {
          E = g.getPublicKeyAlgorithm();
        } catch (e) {
      ...
      return {
        ...
        rawId: t(R),
        response: {
          attestationObject: t(g.attestationObject),
          clientDataJSON: t(g.clientDataJSON),
          transports: A,
        ...
        authenticatorAttachment: u(f.authenticatorAttachment),
      };
    });
});
