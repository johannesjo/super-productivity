...
import './locales/en';
import './locales/de';
import { createTranslator, localeCodes, missingKeys, registerLocale, resolveDict, translate, } from './i18n';
describe('i18n framework', () => {
    ...
    it('falls back to the raw key when unknown', () => {
        expect(translate(resolveDict('en'), 'totally.unknown.thing')).toBe('totally.unknown.thing');
    });
