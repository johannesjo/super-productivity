...
import { buildWorklogRows, eisenhowerBuckets, eisenhowerQuadrant, isImportant, isUrgent, recentHistory, worklogToCsv, } from './index';
...
describe('Eisenhower derivation', () => {
    ...
    it('buckets a mix of tasks into the four quadrants', () => {
        ...
        expect(eisenhowerQuadrant(task({ priority: 3, dueDay: '2026-07-19' }), today)).toBe('importantUrgent');
    });
});
describe('worklog projection and CSV', () => {
    ...
    it('exports a CSV that escapes commas, quotes and newlines', () => {
        ...
        expect(csv.split('\n')[0]).toBe('date,task,project,started_utc,ended_utc,duration_ms');
    });
