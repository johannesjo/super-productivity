...
const ctx = { today: '2026-07-20' as const, now: Date.parse('2026-07-20T09:00:00Z') };
...
describe('parseCapture', () => {
  ...
  it('parses start and reminder time', () => {
    ...
    expect(Date.parse(parsed?.reminderAt ?? '')).toBe(
      Date.parse('2026-07-20T09:00:00Z') + 30 * 60_000,
    );
  });
