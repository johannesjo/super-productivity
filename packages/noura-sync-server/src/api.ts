...
export const apiRoutes = async (app: HttpApp): Promise<void> => {
  ...
  app.post<{ Body: PasskeyRegisterOptionsBody }>(
  ...
  app.post<{ Body: PasskeyRegisterVerifyBody }>(
  ...
  app.post<{ Body: PasskeyLoginOptionsBody }>(
  ...
  app.post<{ Body: PasskeyLoginVerifyBody }>(
  ...
  app.post<{ Body: PasskeyRecoveryRequestBody }>(
    '/recover/passkey',
    {
      config: {
        rateLimit: {
  ...
  app.post<{ Body: PasskeyRecoveryOptionsBody }>(
  ...
  app.post<{ Body: PasskeyRecoveryCompleteBody }>(
  ...
  app.post<{ Body: MagicLinkRegisterBody }>(
    '/register/magic-link',
    {
      config: {
        rateLimit: {
  ...
  app.post<{ Body: MagicLinkVerifyBody }>(
