...
const FULL_STATE_OP_TYPES: ReadonlySet<string> = new Set(NOURA_SYNC_SNAPSHOT_OP_TYPES);
...
export type ConflictType =
  'concurrent' | 'superseded' | 'equal_different_client' | 'unknown';
...
export const OP_TYPES = NOURA_SYNC_OP_TYPES;

export type OpType = NouraSyncOpType;
