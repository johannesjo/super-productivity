...
export {
  NOURA_SYNC_CLIENT_ID_REGEX as CLIENT_ID_REGEX,
  NOURA_SYNC_MAX_CLIENT_ID_LENGTH as MAX_CLIENT_ID_LENGTH,
} from '@sp/shared-schema';
...
export const isValidClientId = (cid: unknown): cid is string =>
  typeof cid === 'string' &&
  cid.length <= NOURA_SYNC_MAX_CLIENT_ID_LENGTH &&
  NOURA_SYNC_CLIENT_ID_REGEX.test(cid);
