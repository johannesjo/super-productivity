...
| Add to Today / remove from Today | Uses `planTasksForToday` / `unscheduleTask` per task due today (Today membership is the due date; the tag list is only order). Offered outside the Today list, like the row button.                                                                                                                                                                                                                                                                                                                                                                                           |                                                                                                |
