...
| Calendar roadmap                                                   | [ARCHITECTURE-DECISIONS.md #9 — calendar integration stays read-only](../../ARCHITECTURE-DECISIONS.md#9-calendar-integration-stays-read-only) (CalDAV VEVENT expansion shipped as the `caldav-calendar-provider` plugin)                                                               |
