...
- Press **Escape** to cancel editing and keep the existing shortcut, or **Backspace** or **Delete** to clear an existing binding.
...
- **Conflicts:** The configuration UI warns if two actions are assigned the same key combination. **Escape** cancels editing, while **Backspace** or **Delete** clears an existing assignment.
