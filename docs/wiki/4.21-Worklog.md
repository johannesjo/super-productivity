...
The worklog in Super Productivity is the **full History view** of the time you have logged on tasks: it turns each task's **time spent per day** into a hierarchy of years, months, weeks, and days so you can see what you worked on and for how long on any given date. The worklog is **generated** from your task and archive data; it does not store time separately. The `worklog` and `quick-history` routes are **legacy aliases** that open this same unified History view; see [[4.22-Quick-History]]. Understanding how worklog entries are built, where the data comes from, and how accuracy and refresh work helps you use History and daily summary for review, correction, and export.
...
- [[4.22-Quick-History]] — Legacy alias that now opens the unified History view
