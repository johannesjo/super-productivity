...
**From outside the app (desktop only):** Bind a system-wide key to **Quick add task HUD** under [[3.02-Settings-and-Preferences]] → Keyboard. It opens the same add task bar as a small overlay on top of whatever you are working in, without bringing the main window forward. Press the key again to close it, or use **Escape** or a click outside. Everything below — short syntax, projects, tags, recurrence — works there exactly as it does in the app. It is unbound by default; see [[3.03-Keyboard-Shortcuts]], including the URL-scheme alternative for Wayland.
