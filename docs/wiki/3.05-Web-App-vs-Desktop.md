...
- Android's home-screen task widget, which can show Today or a selected project;
  opening it shows the selected project's list, and completed tasks leave
  selected-project lists after a five-second grace period.
