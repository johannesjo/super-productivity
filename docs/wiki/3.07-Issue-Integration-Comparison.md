...
- **Auto-import:** All open work items in the project, up to 2000 work items scanned per refresh.
...
imports. The desktop and mobile apps are unaffected — they do not go through the browser's
CORS check. Nothing in Super Productivity can change this; it needs Plane to publish CORS
headers. See [[3.05-Web-App-vs-Desktop]].
