...
function we(e, t) {
  const s = A,
    ...
    n = e.length === 0,
    i = t === void 0 ? o : t,
    a = n ? qe : { owned: null, cleanups: null, context: i ? i.context : null, owner: i },
    r = n ? e : () => e(() => z(() => le(a)));
  (E = a), (A = null);
  try {
    return de(r, !0);
...
function Ee(e, t, s, o = K, n) {
  ...
  return E === null || (E !== qe && (E.owned ? E.owned.push(i) : (E.owned = [i]))), i;
}
function Pe(e) {
  if (e.state === 0) return;
  ...
  const t = [e];
  for (; (e = e.owner) && (!e.updatedAt || e.updatedAt < ve); ) e.state && t.push(e);
...
function He(e) {
  for (let t = 0; t < e.observers.length; t += 1) {
    ...
    s.state || ((s.state = me), s.pure ? j.push(s) : W.push(s), s.observers && He(s));
  }
}
function le(e) {
  let t;
  if (e.sources)
    for (; e.sources.length; ) {
      ...
      if (n && n.length) {
        ...
        o < n.length && ((i.sourceSlots[a] = o), (n[o] = i), (s.observerSlots[o] = a));
      }
    }
  if (e.tOwned) {
    ...
    () => {
      ...
      return (
        ...
        z(() => {
          let u, p, g, m, _, $, N, U, V;
          if (f === 0)
            a !== 0 && (Me(i), (i = []), (o = []), (n = []), (a = 0), r && (r = [])),
              s.fallback &&
                ((o = [gt]), (n[0] = we((Ie) => ((i[0] = Ie), s.fallback()))), (a = 1));
          else if (a === 0) {
            ...
            for (u = new Map(), p = new Array(U + 1), l = U; l >= $; l--)
              (V = c[l]), (d = u.get(V)), (p[l] = d === void 0 ? -1 : d), u.set(V, l);
            for (d = $; d <= N; d++)
              (V = o[d]),
                (l = u.get(V)),
                l !== void 0 && l !== -1
      ...
      if (d != null)
        if (r < d && d < i) {
          let l = a,
            k = 1,
            u;
          for (; ++l < n && l < i && !((u = f.get(t[l])) == null || u !== d + k); ) k++;
          if (k > d - r) {
            const p = t[a];
...
function O(e, t, s, o) {
  if ((s !== void 0 && !o && (o = []), typeof t != 'function')) return Se(e, t, o, s);
  q((n) => Se(e, t(), n, s), o);
}
function It(e) {
  let t = e.target;
...
function Se(e, t, s, o, n) {
  ...
  const i = typeof t,
    a = o !== void 0;
  if (((e = (a && s[0] && s[0].parentNode) || e), i === 'string' || i === 'number')) {
    ...
    if (Array.isArray(t)) {
      ...
      } else c ? (s.length === 0 ? _e(e, r, o) : Pt(e, s, r)) : (s && ee(e), _e(e, r));
      s = r;
    } else if (t.nodeType) {
      if (Array.isArray(s)) {
  ...
  if (t.length) {
    ...
    for (let a = t.length - 1; a >= 0; a--) {
      ...
      if (n !== r) {
        ...
        !i && !a ? (c ? e.replaceChild(n, r) : e.insertBefore(n, s)) : c && r.remove();
      } else i = !0;
    }
  ...
  const Ie = async () => {
    ...
    ue = async () => {
      try {
        ...
        h && (g(h.lastSyncTime ? new Date(h.lastSyncTime) : null), _(h.taskCount || 0));
      } catch (h) {
    ...
    Ze = async () => {
      ...
      try {
        if (
          ...
          try {
            ...
            I.success && (D = I.result) != null && D.success
              ...
              : v(
                  ((x = I.result) == null ? void 0 : x.error) || 'Failed to access file',
                  'error',
                );
            return;
          } catch {
        ...
        P != null && P.success
          ? (v('File is accessible and valid!', 'success'), P.preview && N(P.preview))
      ...
      try {
        ...
        h.success
          ? (console.log('Node script test result:', h.result),
            v(`Success! Node ${h.result.nodeVersion} on ${h.result.platform}`, 'success'))
        ...
        if (
          ...
          try {
            ...
            if (!F.success || !((D = F.result) != null && D.success))
              throw new Error(
                ((x = F.result) == null ? void 0 : x.error) || 'Failed to read file',
              );
            ...
            if (
              ...
              const { parseMarkdownToTree: C } = await Oe(
                ...
                Z = C(Y),
                J = (await S.getTasks()).filter((y) => y.projectId === s().projectId),
                R = [];
              if (
                (((y) => {
                  y.forEach((B) => {
            ...
            if (
              ...
              if (!b.success || !((I = b.result) != null && I.success))
                throw new Error(
                  ((H = b.result) == null ? void 0 : H.error) || 'Failed to write file',
                );
            }
            v(
          ...
          P = (I) => {
            ...
            console.log('Received message event:', I.data),
              ((H = I.data) == null ? void 0 : H.messageId) === x
                ? (window.removeEventListener('message', P), D(I.data.response || I.data))
        ...
        te(ge, {
          ...
          get children() {
            ...
            return (
              O(re, () => {
                var he;
                return (he = s()) != null && he.enabled ? 'Active' : 'Not configured';
              }),
              O(
                je,
                (() => {
...
`),
  ...
  t.forEach((i, a) => {
    ...
    const [, c, f, d, l] = r,
      ...
      g = p ? p[1] : void 0,
      m = p ? p[2] : l,
      _ = { id: g, title: m.trim(), isDone: u, children: [], level: Math.floor(k / 2) };
    ...
    e.forEach((n) => {
      ...
      n.subTaskIds &&
        ...
        n.subTaskIds.forEach((a) => {
          ...
          r &&
            !o.has(a) &&
            (i.children.push(r), (r.parentId = n.id), (r.level = i.level + 1), o.add(a));
        })),
...
class Ye {
  ...
  async readFile(t) {
    var o, n;
    if (!S.executeNodeScript) throw new Error('Node script execution not available');
...
...`
            ...
            case 'getSyncInfo':
              T
                ...
                : (n = { success: !0, lastSyncTime: 0, taskCount: 0, isWatching: !1 });
              break;
            case 'checkDesktopMode':
              n = {
                ...
                isDesktop:
                  typeof window < 'u' &&
                  ((o = window.PluginAPI) == null ? void 0 : o.executeNodeScript) !==
                    void 0,
              };
              break;
            default:
          ...
          return (
            console.error('Error handling message:', n), { success: !1, error: n.message }
          );
        }
      }),
      !0)
...
async function Nt(e) {
  ...
  if (!((o = t.result) != null && o.success))
    throw new Error(((n = t.result) == null ? void 0 : n.error) || 'Failed to read file');
...
window.addEventListener('load', async () => {
      ...
      window.PluginAPI.registerHook('action', async (r) => {
        ...
        T &&
          ...
          (r == null ? void 0 : r.type) === 'UpdateProject'
            ? (((f = (c = r == null ? void 0 : r.payload) == null ? void 0 : c.changes) !=
                null &&
                f.taskIds) ||
                ((k =
                  (l =
                    (d = r == null ? void 0 : r.payload) == null ? void 0 : d.project) ==
                  null
                    ? void 0
                    : l.changes) != null &&
                  k.taskIds)) &&
            ...
            : (r == null ? void 0 : r.type) === '[Task] Update Task'
              ? (g =
                  (p = (u = r == null ? void 0 : r.payload) == null ? void 0 : u.task) ==
                  null
                    ? void 0
                    : p.changes) != null &&
                g.subTaskIds &&
  ...
  const o = await ((a = (i = window.PluginAPI) == null ? void 0 : i.loadSyncedData) ==
  null
    ? void 0
    : a.call(i));
  if (o)
...
console.log('Sync-MD Plugin: window.PluginAPI available?', typeof window.PluginAPI < 'u');
function Qe() {
  ...
  console.log('Sync-MD Plugin: root element:', e),
    typeof window.PluginAPI < 'u' && e
      ...
      : (console.log('Sync-MD Plugin: Waiting for PluginAPI...'), setTimeout(Qe, 100));
}
Qe();
