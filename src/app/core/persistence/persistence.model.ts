...
export interface PersistenceBaseModel<T> {
  ...
  saveState(state: T, flags?: { isDataImport?: boolean, isNoSyncChange?: boolean }): Promise<unknown>;
}
...
export interface PersistenceForProjectModel<S, M> {
  ...
  save(projectId: string, state: S, flags?: { isDataImport?: boolean, isNoSyncChange?: boolean }): Promise<unknown>;
