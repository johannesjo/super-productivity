...
export const LS_GOOGLE_LAST_LOCAL_REVISION = LS_PREFIX + 'GOOGLE_LOCAL_LAST_SYNC_CHECK';
export const LS_GOOGLE_LOCAL_LAST_SYNC_CHECK = LS_PREFIX + 'GOOGLE_LOCAL_LAST_SYNC_CHECK';
