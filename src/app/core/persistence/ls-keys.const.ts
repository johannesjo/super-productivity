...
export const LS_TIMELINE_CACHE = LS_PREFIX + 'TIMELINE_CACHE';

export const LS_LAST_IS_MOVE_SCHEDULED_TO_BACKLOG_ADD =
  LS_PREFIX + 'LAST_IS_MOVE_SCHEDULED_TO_BACKLOG_ADD';

export const LS_LAST_IS_MOVE_SCHEDULED_TO_BACKLOG_EDIT =
  LS_PREFIX + 'LAST_IS_MOVE_SCHEDULED_TO_BACKLOG_EDIT';

export const LS_HAS_WELCOME_DIALOG_BEEN_SHOWN =
  LS_PREFIX + 'HAS_WELCOME_DIALOG_BEEN_SHOWN';

export const LS_LAST_FULLSCREEN_EDIT_VIEW_MODE =
  LS_PREFIX + 'LAST_FULLSCREEN_EDIT_VIEW_MODE';
