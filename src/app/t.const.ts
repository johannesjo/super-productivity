  ...
  F: {
    ...
    TASK: {
      ...
      MULTI_SELECT: {
        ...
        D_CONFIRM_DELETE: {
          MSG: 'F.TASK.MULTI_SELECT.D_CONFIRM_DELETE.MSG',
          OK: 'F.TASK.MULTI_SELECT.D_CONFIRM_DELETE.OK',
        },
        S: {
          APPLIED: 'F.TASK.MULTI_SELECT.S.APPLIED',
          APPLIED_PARTIAL: 'F.TASK.MULTI_SELECT.S.APPLIED_PARTIAL',
          DONE: 'F.TASK.MULTI_SELECT.S.DONE',
          MOVED_TO_PROJECT: 'F.TASK.MULTI_SELECT.S.MOVED_TO_PROJECT',
          NOTHING_TO_DO: 'F.TASK.MULTI_SELECT.S.NOTHING_TO_DO',
          UNDONE: 'F.TASK.MULTI_SELECT.S.UNDONE',
          UNSCHEDULED: 'F.TASK.MULTI_SELECT.S.UNSCHEDULED',
        },
        SELECTED_COUNT: 'F.TASK.MULTI_SELECT.SELECTED_COUNT',
        TASKS_TITLE: 'F.TASK.MULTI_SELECT.TASKS_TITLE',
      },
      N: {
