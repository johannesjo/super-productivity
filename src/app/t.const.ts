export const T = {
  ...
  'F': {
    ...
    'GOOGLE': {
      ...
      'EXPORT_TIME': {
        ...
        'S_EQUAL_VALUES': 'F.GOOGLE.EXPORT_TIME.SNACK_EQUAL_VALUES',
        'S_ROW_APPENDED': 'F.GOOGLE.EXPORT_TIME.SNACK_ROW_APPENDED'
      },
      'S': {
    ...
    'JIRA': {
      ...
      'S': {
        'ADDED_WORKLOG_FOR': 'F.JIRA.SNACK.ADDED_WORKLOG_FOR',
        ...
        'TRANSITION': 'F.JIRA.SNACK.TRANSITION',
        'TRANSITION_SUCCESS': 'F.JIRA.SNACK.TRANSITION_SUCCESS',
        'TRANSITIONS_LOADED': 'F.JIRA.SNACK.TRANSITIONS_LOADED',
    ...
    'REMINDER': {
      'S_REMINDER_ERR': 'F.REMINDER.SNACK_REMINDER_ERR'
    },
    'SIMPLE_TASK_EXPORT': {
  ...
  'FILE_IMEX': {
    ...
    'S_ERR_INVALID_DATA': 'FILE_IMEX.SNACK_ERR_INVALID_DATA'
  },
  'F_AUTO_BACKUPS': {
  ...
  'PP': {
    ...
    'S_INVALID_JSON': 'PP.SNACK_INVALID_JSON',
    'TITLE': 'PP.TITLE',
