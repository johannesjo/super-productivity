export type GitTransitionOption = 'ALWAYS_ASK' | 'DO_NOT' | string;

export interface GitTransitionOptions {
  OPEN: GitTransitionOption;
  IN_PROGRESS: GitTransitionOption;
  DONE: GitTransitionOption;
}
...
export interface GitCfg {
  ...
  availableTransitions: GitTransitionOptions;
