...
@Component({
  selector: 'week-planner-calendar-event',
  templateUrl: './week-planner-calendar-event.component.html',
  styleUrl: './week-planner-calendar-event.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class WeekPlannerCalendarEventComponent {
