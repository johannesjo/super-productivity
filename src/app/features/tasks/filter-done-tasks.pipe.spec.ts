...
describe('filterDoneTasks()', () => {
  ...
  it('should filter done', () => {
    const r = filterDoneTasks([{isDone: true}, {isDone: false}, {isDone: true}] as any, null, true, false);
  ...
  it('should not filter', () => {
    const r = filterDoneTasks([{isDone: true}, {isDone: false}, {isDone: true}] as any, null, false, false);
