...
export enum IPC {
  ...
  PLUGIN_NODE_SCRIPT_RESULT = 'PLUGIN_NODE_SCRIPT_RESULT',
  PLUGIN_REGISTER_FOR_NODE = 'PLUGIN_REGISTER_FOR_NODE',
  PLUGIN_UNREGISTER_FOR_NODE = 'PLUGIN_UNREGISTER_FOR_NODE',
