...
export enum IPC {
  ...
  QUICK_ADD_SHOW = 'QUICK_ADD_SHOW',
  QUICK_ADD_CLOSE = 'QUICK_ADD_CLOSE',
  QUICK_ADD_OPENED = 'QUICK_ADD_OPENED',
  QUICK_ADD_BRIDGE_READY = 'QUICK_ADD_BRIDGE_READY',
  QUICK_ADD_TASK_SUBMIT_BRIDGE_READY = 'QUICK_ADD_TASK_SUBMIT_BRIDGE_READY',
  QUICK_ADD_SNAPSHOT_REQUEST = 'QUICK_ADD_SNAPSHOT_REQUEST',
  QUICK_ADD_SNAPSHOT_RESPONSE = 'QUICK_ADD_SNAPSHOT_RESPONSE',
  QUICK_ADD_TASK_SUBMIT_REQUEST = 'QUICK_ADD_TASK_SUBMIT_REQUEST',
  QUICK_ADD_TASK_SUBMIT_RESPONSE = 'QUICK_ADD_TASK_SUBMIT_RESPONSE',
  ...
  OPEN_SYSTEM_KEYBOARD_SETTINGS = 'OPEN_SYSTEM_KEYBOARD_SETTINGS',
